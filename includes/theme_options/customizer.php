<?php
  ...
  ********************************************/
  function dohko_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control( 
      new WP_Customize_Color_Control( 
        $wp_customize, 'main_color_text', array(
  ...
  function dohko_customize_colors() {
    ...
    $h_text = get_option( 'h_text' );
    $h_text_hover = get_option( 'h_text_hover' );
    ...
    $main_text = get_option( 'main_color_text' );
  ...
  ?>
    ...
    /* color scheme */
      ...
      .cita,
      .cita:hover{
        background-color: <?php echo $h_text_hover; ?> !important; 
      }
      .cita a,
      .cita a:hover{
